...
<head>
	...
	/*	$(function(){
			...
			$("#captchaImage").click(function(){//点击更换验证码
	 			$("#captchaImage").src = "/cmfz/yanzheng.do?time="+new Date();
			});
...
*/
        function fun(tag){
            tag.src ="/cmfz/yanzheng.do?time="+new Date();
        }
	</script>
</head>
<body>
		...
		<div class="login">
			<form id="loginForm" action="/cmfz/tadmin/login.do" method="post" >
					  ...
					  <tr>
						...
						<tr>
							...
							<td>
								...
								<img id="captchaImage" onclick="fun(this)" class="captchaImage" src="/cmfz/yanzheng.do" title="点击更换验证码"/>
							</td>
						</tr>					
					<tr>
						<td>
